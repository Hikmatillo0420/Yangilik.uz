...
if(isset($_SESSION['logIn'])){
    header("location: /Register/Login/logout.php");
}
?>

<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="/admin"><b>Yangliklar.uz</b></a>
        ...
        <div class="ml-auto">
            <a class='btn btn-dark' href="/Register/Login/login.php">Chiqish</a>
